...
if (isset($_POST['submit'])) 
{
    ...
    $to = "liudas.radzius@dimax.lt"; // Admin email address
    $from = $_POST['email']; // Sender email address
    $name = $_POST['vardas'];
    $telefonas = $_POST['numeris'];
    $subject = "Origo power Klientas užpildė formą";
    $message = "Origo power internetinėje svetainėje klientas užpildė kontaktų formą." . "\n\n" .
               $name . " norėtų įsivertinti galimybę įsirengti saulės elektrinę." . "\n\n" .
               "Prašau susisiekti su Klientu." . "\n\n" .
               "Kliento vardas: " . $name  . "\n\n" .
               "El. paštas: " . $from . "\n\n" .
               "Tel. Nr.: " . $telefonas . "\n\n" .
    $headers = "From: " . $from;
