...
<table class="table">
    ...
    $username = "lluuddaass_origo8171q";
    $password = "E77rqk2kAgrQuRR2";
    $dbname = "lluuddaass_origoklientai";
    ...
    $sql = "SELECT Vartotojo_id, Suvartojimas, Elektros_tiekejo_kaina, Rekomenduojama_galia, Montavimo_vieta, Stogo_slaito_puse, Seselio_kiekis, Stogo_danga, Elektros_ivadas, Ivado_galia, Atsiskaitymas, Valstybes_parama, Vardas, Pavarde, Tel_Nr, El_pastas, Gatve, Namo_nr, Miestas, Imones_pavadinimas, Zinute from forma";
